...
export const studentMenu = [
    { text: "لوحة التحكم", icon: <SpaceDashboardIcon />, url: "/studentDashboard" },
    { text: "الطلاب", icon: <PeopleIcon />, url: "/studentDashboard/students" },
    { text: "المعلمون", icon: <CoPresentIcon />, url: "/studentDashboard/teachers" },
    { text: "المواد الدراسية", icon: <MenuBookIcon />, url: "/studentDashboard/subjects" },
    { text: "الصفوف الدراسية", icon: <ClassIcon />, url: "/studentDashboard/classrooms" },
    { text: "الجداول", icon: <CalendarMonthIcon />, url: "/studentDashboard/schedules" },

    {
        ...
        children: [
            ...
            },
            {
                ...
                icon: <FactCheckIcon />,
                url: "/studentDashboard/exams/results",
            },
        ],
    },

    { text: "الدرجات", icon: <GradeIcon />, url: "/studentDashboard/grades" },
    { text: "النقل المدرسي", icon: <DirectionsBusFilledIcon />, url: "/studentDashboard/buses" },
];
...
export default function StudentDrawer() {
    ...
    const menuItems = React.useMemo(() => (studentMenu), [isTeacher]);
