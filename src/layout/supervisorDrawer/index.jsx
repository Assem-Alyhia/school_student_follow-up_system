...
import Diversity3Icon from "@mui/icons-material/Diversity3";        // الآباء
...
export const supervisorMenu = [
    { text: "لوحة التحكم", icon: <SpaceDashboardIcon />, url: "/supervisorDashboard" },
    { text: "الطلاب", icon: <PeopleIcon />, url: "/supervisorDashboard/students" },
    { text: "الآباء", icon: <Diversity3Icon />, url: "/supervisorDashboard/parents" },
    { text: "النقل المدرسي", icon: <DirectionsBusFilledIcon />, url: "/supervisorDashboard/buses" },
];
...
export default function SupervisorDrawer() {
    ...
    const menuItems = React.useMemo(() => (supervisorMenu), [isTeacher]);
