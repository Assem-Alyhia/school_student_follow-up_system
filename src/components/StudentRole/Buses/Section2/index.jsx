// src/components/StudentRole/Buses/Section2.jsx
import React, { useState } from "react";
import { useQuery } from "@tanstack/react-query";
import PaginationSection from "../../../../layout/PaginationSection";
import Section1 from "../Section1";
import { getStudentBuses } from "../../../../api/Student/Buses/getStudentBuses";
...
export default function Section2() {
    ...
    const { data, isLoading, isError, error } = useQuery({
        ...
        queryFn: () => getStudentBuses({ page, per_page: rowsPerPage }),
    ...
    const perPage = Number(data?.meta?.per_page ?? rowsPerPage) || rowsPerPage;
    const lastPage = Number(data?.meta?.last_page ?? Math.max(1, Math.ceil(total / perPage)));
