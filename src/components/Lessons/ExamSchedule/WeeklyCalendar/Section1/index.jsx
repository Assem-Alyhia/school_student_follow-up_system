    ...
    return (
        <Box sx={{ width: '100%', p: isMobile ? 1 : 3, bgcolor: '#f5f7fa' }}>
            <Paper sx={{ p: isMobile ? 1 : 3, bgcolor: 'white', direction: 'rtl' }}>
                ...
                {loading && <Typography textAlign="center" sx={{ py: 2 }}>جاري تحميل البيانات...</Typography>}
                {error && <Typography color="error" textAlign="center" sx={{ py: 2 }}>{error}</Typography>}
