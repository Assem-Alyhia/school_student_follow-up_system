...
import { getAdminExamsList } from "../../../../api/Admin/Exams/getAdminExamsList";
import { deleteAdminExam } from "../../../../api/Admin/Exams/deleteAdminExam";
...
const Section2 = ({ page = 1, rowsPerPage = 10, onMeta }) => {
    ...
    const { data, isLoading, isError, error } = useQuery({
        queryKey: ["admin-exams", page, rowsPerPage],
        queryFn: () => getAdminExamsList({ page, per_page: rowsPerPage }),
        keepPreviousData: true,
        staleTime: 60_000,
    });

    const deleteMutation = useMutation({
        mutationFn: (id) => deleteAdminExam(id),
        onSuccess: () => {
            setShowSuccess(true);
