// src/components/SupervisorRole/Dashboard/OverviewSection.jsx
...
import { getSupervisorDashboard } from "../../../../api/Supervisor/Dashboard/getSupervisorDashboard";
        ...
        >
            ...
            {isError && (
                <Alert severity="error" sx={{ mb: 2 }}>
                    فشل في جلب بيانات لوحة المشرف — {error?.message || "حدث خطأ غير متوقع"}
                </Alert>
            )}
