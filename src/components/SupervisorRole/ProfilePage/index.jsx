// src/components/Supervisor/ProfilePage.jsx
    ...
    return (
        <Box sx={{ p: 3, direction: "rtl", bgcolor: "#f8f9fa" }}>
            ...
            <Paper sx={{ p: 3, mb: 4, borderRadius: 3 }} elevation={1}>
                ...
                <Box display="flex" alignItems="center" mb={2}>
                    ...
                    >
                        {(!profileData.image || profileData.image === "") &&
                            (profileData.fullName?.charAt(0) || "م")}
                    </Avatar>
                    <Box>
                ...
                <Row label="الرقم (Supervisor)" value={profileData.supervisorPrefix} hideDivider />
            </Paper>
