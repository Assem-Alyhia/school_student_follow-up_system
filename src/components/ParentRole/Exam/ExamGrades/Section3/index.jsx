...
import { getParentExamResults } from "../../../../../api/Parent/Exams/getParentExamResults";
...
export default function Section3() {
    ...
    const { data, isLoading, isError, error } = useQuery({
        queryKey: ["parent-exam-results", page, rowsPerPage],
        queryFn: () => getParentExamResults(page, rowsPerPage),
