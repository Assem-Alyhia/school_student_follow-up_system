...
import { getParentExams } from "../../../../../api/Parent/Exams/getParentExams";
...
export default function Section2({ page = 1, rowsPerPage = 10, onMeta }) {
    ...
    const { data, isLoading, isError, error } = useQuery({
        queryKey: ["parent-exams"],
        queryFn: () => getParentExams(),
        staleTime: 60_000,
    });
    ...
    return (
        <Box sx={{ p: 3 }} dir="rtl">
            <Paper elevation={0} sx={{ p: 2 }}>
                {/* الفلاتر العلوية داخل نفس القسم */}
