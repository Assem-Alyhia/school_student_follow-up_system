// src/components/Students/studentForAdd.jsx
...
export default function StudentForm() {
    ...
    const schoolFees = Array.isArray(schoolFeesData) ? schoolFeesData : schoolFeesData?.data || [];
    ...
    const anyLoading =
        parentsLoading || classroomsLoading || supervisorsLoading || feesLoading;

    const anyError =
        parentsErr || classroomsErr || supervisorsErr || feesErr;
    ...
    return (
        <Container maxWidth="lg" dir="rtl">
            ...
            {anyLoading && <Box sx={{ p: 2 }}>جاري تحميل القوائم...</Box>}
            {anyError && (
                ...
                <Grid item xs={12} md={6}>
                        ...
                        <Grid container spacing={2} mt={1}>
                            ...
                            <Grid item xs={12} md={8}>
                                <Autocomplete
                                    ...
                                    renderInput={(params) => (
                                        <TextField {...params} label="الجنس" margin="dense" />
                                    )}
                                />
                    ...
                    <Paper sx={{ mt: 3, p: 2 }}>
                        ...
                        <Autocomplete
                            ...
                            onChange={(_, value) =>
                                handleAutocompleteChange("parent_id", value?.id || "")
                            }
                            renderInput={(params) => (
                                <TextField {...params} label="ولي الأمر" margin="dense" />
                            )}
                        ...
                        <Autocomplete
                            ...
                            getOptionLabel={(option) => option?.name || ""}
                            onChange={(_, value) =>
                                handleAutocompleteChange("classroom_id", value?.id || "")
                            }
                            renderInput={(params) => (
                                <TextField {...params} label="الصف" margin="dense" />
                            )}
                        ...
                        <Autocomplete
                            ...
                            getOptionLabel={(option) => option?.name || ""}
                            onChange={(_, value) =>
                                handleAutocompleteChange("supervisor_id", value?.id || "")
                            }
                            renderInput={(params) => (
                                <TextField {...params} label="المشرف" margin="dense" />
                            )}
                ...
                <Grid item xs={12} md={6}>
                    ...
                    <Paper sx={{ mt: 3, p: 2 }}>
                        ...
                        <Autocomplete
                            ...
                            renderInput={(params) => (
                                <TextField {...params} label="حالة الطالب" margin="dense" />
                            )}
                        />
                    ...
                    <Paper sx={{ mt: 3, p: 2 }}>
                        ...
                        <Autocomplete
                            ...
                            getOptionLabel={(option) => option?.name || ""}
                            onChange={(_, value) =>
                                handleAutocompleteChange("school_fee_id", value?.id || "")
                            }
                            renderInput={(params) => (
                                <TextField {...params} label="الرسوم" margin="dense" />
                            )}
                            loading={feesLoading}
                        />
                        ...
                        <Autocomplete
                            ...
                            getOptionLabel={(option) => option.label}
                            onChange={(_, newValue) =>
                                handleAutocompleteChange("discount_status", newValue?.value || "")
                            }
                            renderInput={(params) => (
                                <TextField {...params} label="حالة الخصم" margin="dense" />
                            )}
                        />
                        ...
                        <Autocomplete
                            ...
                            getOptionLabel={(option) => option.label}
                            onChange={(_, newValue) =>
                                handleAutocompleteChange("payment_status", newValue?.value || "")
                            }
                            renderInput={(params) => (
                                <TextField {...params} label="حالة الدفع" margin="dense" />
                            )}
                        />
                    ...
                    <Box sx={{ display: "flex", justifyContent: "end", mt: 2 }}>
                        ...
                        >
                            {createMut.isPending ? "جارٍ الحفظ..." : "حفظ الطالب"}
                        </Button>
                    </Box>
                </Grid>
            </Grid>
