...
const TeacherStageDetailsModal = ({ open, onClose, stageKey, stageTitle }) => {
    const levelsQuery = useQuery({
        queryKey: ['levels-stats'],
        queryFn: getAllTeacherLevels,
        enabled: open,
        staleTime: 60_000,
    });
    ...
    const classroomsQuery = useQuery({
        ...
        queryFn: async () => {
            const allRows = await getAllTeacherClassrooms(); 
...
export default TeacherStageDetailsModal;
